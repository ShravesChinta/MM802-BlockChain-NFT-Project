...
NFTServer : Responsible For Providing the NFTs details associated with the particular wallet address.
ClientGUI : GUI application designed to be used by the clients of lamose. Provides option of selecting and sending NFTs
LamoseGUI : GUI application created to view the NFTs engraving request received from the clients/customers.
